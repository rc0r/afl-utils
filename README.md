...
* and of course you'll need [afl](http://lcamtuf.coredump.cx/afl/) for `afl_multicore`, `afl_multikill`
...
Usage:
    ...
    afl_collect copies all crash sample files from an afl sync dir used by multiple
    ...
    optional arguments:
      ...
      -j NUM_THREADS, --threads NUM_THREADS
                            ...
                            threads afl_collect will utilize.
      -r, --remove-invalid  Verify collected crash samples and remove samples that
                            do not lead to crashes (runs 'afl_vcrash -qr' on collection
...
Usage:
    ...
    afl_multikill aborts all afl-fuzz instances belonging to an active
    afl_multicore session. Interactive screen sessions are not supported!

    optional arguments:
      -h, --help            show this help message and exit
      -S SESSION, --session SESSION
                            afl_multicore session to abort
                            (Default='SESSION').
...
Usage:
    ...
    afl_vcrash [-f LIST_FILENAME] [-h] [-j THREADS] [-q] [-r] collection_dir
    ...
    optional arguments:
      ...
      -j NUM_THREADS, --threads NUM_THREADS
                            ...
                            number of threads afl_vcrash will utilize.
